...
//	}
	...
	public int todoInsert(Member loginMember) {
		return sqlSession.insert("memberMapper.todoInsert", loginMember);
	}
	...
	public List<Member> todoSelect(int memberNo) {
		return sqlSession.selectList("memberMapper.todoSelect", memberNo);
	}
	...
	public int todoAllDelete(int memberNo) {
		return sqlSession.delete("memberMapper.todoAllDelete", memberNo);
	}
	...
	public int todoDelete(int todoNo) {
		return sqlSession.delete("memberMapper.todoDelete", todoNo);
	}
